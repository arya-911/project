...
void Student::storeDataInFile()
{
    Student a;
    a.StudentData();
    // ofstream to write if stream to read
    ofstream fout;
...
void AssignmentForAll::searchDataInFile(char *s)
{
    ...
    while (!fin.eof())
    {
        //compare2 string without senstivity to case
...
void now()
{
    ...
    cout << "For Registartion of student Enter 1" << endl;
    cout << "For Registartion of student Enter 2" << endl;
